...
{                               /* --- integer hash function */
  return (size_t)(*(const int*)i ^ type);
}  /* st_inthash() */
...
void* my_st_insert (SYMTAB *tab, const void *key, int type,
...
void* my_st_lookup (SYMTAB *tab, const void *key, int type)
{                               /* --- look up a symbol */
  size_t i;                     /* index of hash bin */
